                    ...
                    <div class="row g-0 h-100 align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center"><img class="me-3"
                                    src="https://prium.github.io/falcon/v3.13.0/assets/img/icons/weather-icon.png"
                                    alt="" height="60" />
                                <div>
        ...
        <div class="col-lg-6 col-xl-5 col-xxl-4 mb-3 ps-lg-2">
            <div class="card h-lg-100">
                <div class="bg-holder bg-card"
                    style="background-image:url(https://prium.github.io/falcon/v3.13.0/assets/img/icons/spot-illustrations/corner-1.png);">
                </div>
                <!--/.bg-holder-->
                            ...
                            <tbody>
                                <tr class="border-bottom border-200">
                                    <td>
                                        <div class="d-flex align-items-center position-relative"><img
                                                ...
                                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/12.png"
                                                width="60" alt="" />
                                ...
                                <tr class="border-bottom border-200">
                                    <td>
                                        <div class="d-flex align-items-center position-relative"><img
                                                class="rounded-1 border border-200"
                                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/10.png"
                                                width="60" alt="" />
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-1 fw-semi-bold"><a class="text-dark stretched-link"
                                                        href="#!">Boots4</a></h6>
                                ...
                                <tr class="border-bottom border-200">
                                    <td>
                                        <div class="d-flex align-items-center position-relative"><img
                                                class="rounded-1 border border-200"
                                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/11.png"
                                                width="60" alt="" />
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-1 fw-semi-bold"><a class="text-dark stretched-link"
                                                        href="#!">Falcon</a></h6>
                                ...
                                <tr class="border-bottom border-200">
                                    <td>
                                        <div class="d-flex align-items-center position-relative"><img
                                                class="rounded-1 border border-200"
                                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/14.png"
                                                width="60" alt="" />
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-1 fw-semi-bold"><a class="text-dark stretched-link"
                                                        href="#!">Slick</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center position-relative"><img
                                                class="rounded-1 border border-200"
                                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/13.png"
                                                width="60" alt="" />
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-1 fw-semi-bold"><a class="text-dark stretched-link"
                                                        href="#!">Reign Pro</a></h6>
                ...
                <div class="card-body pb-0">
                    <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                        <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2"
                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/5-thumb.png"
                                alt="" /></div>
                        <div class="ms-3 flex-shrink-1 flex-grow-1">
                            ...
                            <div class="hover-actions end-0 top-50 translate-middle-y"><a
                                    ...
                                    href="https://prium.github.io/falcon/v3.13.0/assets/img/icons/cloud-download.svg"
                                    download="download"><img
                                        src="https://prium.github.io/falcon/v3.13.0/assets/img/icons/cloud-download.svg"
                                    ...
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img
                                        src="https://prium.github.io/falcon/v3.13.0/assets/img/icons/edit-alt.svg"
                    ...
                    <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                        <div class="file-thumbnail"><img class="img-fluid"
                                src="https://prium.github.io/falcon/v3.13.0/assets/img/icons/zip.png" alt="" />
                        </div>
                        <div class="ms-3 flex-shrink-1 flex-grow-1">
                    ...
                    <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                        <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2"
                                src="https://prium.github.io/falcon/v3.13.0/assets/img/products/2-thumb.png"
                                alt="" /></div>
                        <div class="ms-3 flex-shrink-1 flex-grow-1">
                            <h6 class="mb-1"><a class="stretched-link text-900 fw-semi-bold"
                                    href="#!">iMac.jpg</a></h6>
                    ...
                    <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                        <div class="file-thumbnail"><img class="img-fluid"
                                src="https://prium.github.io/falcon/v3.13.0/assets/img/icons/docs.png" alt="" />
                        </div>
                        <div class="ms-3 flex-shrink-1 flex-grow-1">
                            <h6 class="mb-1"><a class="stretched-link text-900 fw-semi-bold"
                ...
                <div class="card-body py-2">
                    <div class="d-flex align-items-center position-relative mb-3">
                        <div class="avatar avatar-2xl status-online">
                            <img class="rounded-circle" src="https://prium.github.io/falcon/v3.13.0/assets/img/team/1.jpg"
                                alt="" />
                        </div>
                        <div class="flex-1 ms-3">
                    ...
                    <div class="d-flex align-items-center position-relative mb-3">
                        <div class="avatar avatar-2xl status-online">
                            <img class="rounded-circle" src="https://prium.github.io/falcon/v3.13.0/assets/img/team/2.jpg"
                                alt="" />
                        </div>
                        <div class="flex-1 ms-3">
                            <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                    ...
                    <div class="d-flex align-items-center position-relative mb-3">
                        <div class="avatar avatar-2xl status-away">
                            <img class="rounded-circle" src="https://prium.github.io/falcon/v3.13.0/assets/img/team/3.jpg"
                                alt="" />
                        </div>
                        <div class="flex-1 ms-3">
                            <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                    ...
                    <div class="d-flex align-items-center position-relative mb-3">
                        <div class="avatar avatar-2xl status-offline">
                            <img class="rounded-circle" src="https://prium.github.io/falcon/v3.13.0/assets/img/team/4.jpg"
                                alt="" />
                        </div>
                        <div class="flex-1 ms-3">
                            <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                    ...
                    <div class="d-flex align-items-center position-relative false">
                        <div class="avatar avatar-2xl status-offline">
                            <img class="rounded-circle" src="https://prium.github.io/falcon/v3.13.0/assets/img/team/5.jpg"
                                alt="" />
                        </div>
                        <div class="flex-1 ms-3">
                            <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
        ...
        <div class="col-sm-6 col-xxl-3 ps-sm-2 order-xxl-1 mb-3 mb-xxl-0">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-center flex-column">
                    ...
                    <!-- If you are not using gulp based workflow, you can find the transpiled code at: public/https://prium.github.io/falcon/v3.13.0/assets/js/theme.js-->
                ...
                <div class="card-footer bg-light py-2">
                    <div class="row flex-between-center">
                        ...
                        <div class="col-auto"><a class="fs--1 font-sans-serif" href="#!">Help</a>
                        </div>
                    </div>
                </div>
            </div>
