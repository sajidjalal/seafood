...
<head>
    ...
    <title>{{ $page_title ?? 'Seafood Company' }}</title> <!-- Favicon & Icons Start -->
    ...
    <link rel="stylesheet" href=" {{ asset('new_look/css/theme/easy-responsive-tabs.css') }}" /> <!-- fonts -->
...
<body>
    ...
    <footer>
        ...
        <div class="copy"> Copyright © {{ date('Y') }} {{ COMPANY_NAME }} | All Rights Reserved
