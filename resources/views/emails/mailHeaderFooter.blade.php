...
<body>
    ...
    <div class="main_border">
        <div style="position:relative; display:block; padding:20px; background-color: #fffafa;">
            ...
            {{-- <hr style="border: 0; border-top: 1px solid #d2e8ff; height:1px; font-size:10px;">
            <h4 style="padding: 0 !important;margin-bottom: 0;">Regards</h4>
            <h4 class="h4_class">{{ C_INSURANCE_COMP_FULL }}</h4> --}}
        </div>
    </div>
</body>
